...
/**
 * Load a video.  Always mutes first (satisfies Chrome autoplay policy),
 * then immediately re-applies the real volume.  Call this from user-gesture
 * handlers so the synchronous unMute() still runs in the gesture context.
 */
...
export function PlayerProvider({ children }) {
  ...
  return (
    <PlayerContext.Provider value={{ seekTo, playTrack, togglePlay }}>
      {children}
      {/*
